...
const Privacy = () => {
  // Update the privacy policy text here
  ...
  return (
    <div>
      ...
      >
        ...
        Jan Bendheim er behandlingsansvarlig for behandlingen av
        ...
        for:{" "}
        <a href="https://www.helved.net" target="_blank">
          www.helved.net
        </a>
        .<h3>Personopplysninger vi samler inn og behandler</h3>
        ...
        <ul>
          ...
          <li>
            ...
            elektronisk kommunikasjon vi sender ut. Samt teknisk informasjon om
            enhetene du bruker.
          </li>
          <li>
            Cookies: se vår informasjon om cookies{" "}
            <a
              href="https://www.tomandveronika.com/legal/cookiepolicy"
              target="_blank"
            >
              her
            </a>
        ...
        <b>Levering av tjeneste/avtaleinngåelse</b>
        <br />
        ...
        <br />
        <br />
        <b>Administrasjon av kundeforhold</b>
        <br />
        ...
        <br />
        <br />
        <b>Analyse, forretningsutvikling og forbedring av tjenester</b>
        <br />
        ...
        <br />
        <br />
        <b>Tilpasset brukeropplevelse</b>
        <br />
        ...
        <br />
        <br />
        <b>Systemovervåking, feilretting mm.</b>
        <br />
        ...
        <br />
        <br />
        <b>Sikkerhet, avdekking av svindel og kriminelle handlinger</b>
        <br />
        ...
        <br />
        <br />
        <b>Overholde rettslige forpliktelser</b>
        <br />
        ...
        knyttet til salg, som vi er pliktig til å regnskapsføre og oppbevare i
        henhold til bokføringsloven. Det rettslige grunnlaget for å behandle
        ...
        <br />
        <br />
        <h3>tredjepartsleverandører</h3>
        <br>
          Vi benytter tredjepartsleverandører som databehandlere for å bistå med
          levering og forbedring av våre tjenester. Disse leverandørene kan ha
          tilgang til dine personopplysninger som en del av deres tjenester, og
          vi har inngått databehandlingsavtaler med hver leverandør for å sikre
          at de behandler dine opplysninger i samsvar med gjeldende
          personvernregler og våre instruksjoner. Vær oppmerksom på at dine
          opplysninger kan bli lagret og behandlet i land utenfor ditt
          bostedsland eller det landet hvor opplysningene opprinnelig ble samlet
          inn, inkludert land som ikke har samme grad av beskyttelse av
          personopplysninger som ditt hjemland. Vi tar rimelige forholdsregler
          for å sikre at dine personopplysninger fortsatt beskyttes i samsvar
          med gjeldende lover."
        </br>
        <h3>Dine rettigheter</h3>
        Dersom du ønsker å utøve noen av dine rettigheter, ta kontakt med oss på{" "}
        <a href="mailto:tomelbin.bendheim@gmail.com">
          tomelbin.bendheim@gmail.com
        </a>
        .<br />
        <br />
        <b>Rett til innsyn i egne opplysninger</b>
        <br />
        ...
        <br />
        <br />
        <b>Begrensning av behandling av personopplysninger</b>
        <br />
        ...
        <br />
        <br />
        <b>Protestere mot en behandling av personopplysninger</b>
        <br />
        ...
        <br />
        <br />
        <b>Du kan klage på vår behandling av personopplysninger</b>
        <br />
        ...
        <p>
          ...
          personvernerklæring fra gdprcontrol.no{" "}
        </p>
      </div>
      <p>
