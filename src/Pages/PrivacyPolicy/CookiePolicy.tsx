...
const CookiePolicy = () => {
  return (
    <div>
      ...
      <div>
        This Cookie Policy explains how Tom-Elbin Bendheim ENK ("
      ...
      <div>
        Cookies set by the website owner (in this case, Tom-Elbin Bendheim ENK)
      ...
      <div>
        ...
        Cookie Policy regularly to stay informed about our use of cookies and
      ...
      <div>
        ...
        technologies, please email us at tomelbin.bendheim@gmail.com or by post
        to:
      </div>
      <div>Tom-Elbin Bendheim ENK</div>
      <div>Hagapynten 15</div>
      <div>Oslo, Oslo 0673</div>
      <div>Norway</div>
      <div>Phone: (+1)97890199</div>
    </div>
  );
};
