...
/*Alternativ på nav: bg-transparent backdrop-blur-xl dark:backdrop-brightness-50 backdrop-brightness-125 */
	return (
		<section className="bg-white dark:bg-black row-start-1 row-span-2 col-span-full h-fit">
			...
			<nav className={``}>
				...
				<div className={`grid ${toggleDD ? "grid-rows-navBar2":"grid-rows-navBar1"} md:grid-rows-1 md:h-24 auto-rows-auto grid-cols-12 items-center`}>
					...
					<a href="/" className='text-white whitespace-nowrap col-start-2 justify-self-start row-start-1'>
						HEL VED
					</a>
					...
					>
						...
						<ul className={` ${toggleDD ? "flex-col" : "hidden"} md:flex col-start-2 justify-self-start row-start-2 md:row-start-1  md:justify-self-end md:col-end-12`}>
						{/*  <li>
